...
import iSmileImg from '../../assets/images/ismilelogo.png'
      ...
      <div className='projects-wrapper'>
        ...
        <div className='project-container'>
          <div className='project-img'>
            <img src={iSmileImg} alt="Alter ego e-commerce" className='adjust-project-img' />
          </div>
          <div className='project-info'>
            <h3 className='project-title'>I Smile e-commerce</h3>
            <p className='project-description'>Currently co-developing/designing this freelance project for cloth brand. HTML -EJS template based-, and pure CSS/Javascript for the front
              and MySQL with Sequelize and Javascript with AWS integration to create a CRUD of products and users with its respective validations/relations. In addition, we used several tools and libraries to develop different functionalities according to client requirements.
            </p>
            ...
            <div className='project-links-container'>
              <button className='project-link-btn'><Link to='https://ismile.com.ar' target='_blank'>DEPLOY</Link></button>
